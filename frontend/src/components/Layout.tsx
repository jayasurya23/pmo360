...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col">
      ...
      <main className="flex-1 px-[clamp(1.5rem,3vw,5rem)] py-8 max-w-[1800px] w-full mx-auto">
        <Suspense
          fallback={
...
function TopNav() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/90 backdrop-blur border-b border-slate-200">
      <div className="max-w-[1800px] mx-auto px-[clamp(1.5rem,3vw,5rem)] h-16 flex items-center gap-6">
        <NavLink
          to={LEAD_PATH}
          className="shrink-0"
...
function ContextBar({
  ...
  return (
    <div className="bg-white border-b border-slate-200">
      <div className="max-w-[1800px] mx-auto px-[clamp(1.5rem,3vw,5rem)] py-3 flex items-center gap-2">
        <ContextSwitcher />
        <ContextAdminGear
          hasClient={!!client}
          hasProject={!!project}
...
function MeetingStepper({ currentPath }: { currentPath: string }) {
  ...
  return (
    <div className="bg-gradient-to-b from-white to-slate-50 border-b border-slate-200">
      <div className="max-w-[1800px] mx-auto px-[clamp(1.5rem,3vw,5rem)] py-3">
...
function Footer() {
  return (
    <footer className="border-t border-slate-200 bg-white py-4 mt-auto">
      <div className="max-w-[1800px] mx-auto px-[clamp(1.5rem,3vw,5rem)] text-xs text-slate-500 flex justify-between">
